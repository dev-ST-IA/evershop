...
export default function Products({
  collection: { code, addProductApi, includeAll:includeAllDft, includeAllOrderBy }
}) {
  ...
  const [includeAll, setIncludeAll] = React.useState(includeAllDft === 1)
        ...
        <Card.Session>
          <div>
            <div>
              ...
              {includeAll && (
                <Field
                  id="include_all_order_by"
                  name="include_all_order_by"
                  type="select"
                  label="Order By"
                  value={includeAllOrderBy ?? 0}
                  options={mgconstants.collections.order_by_options}
                />
              )}
            </div>
            {
...
Products.propTypes = {
  collection: PropTypes.shape({
    ...
    includeAll: PropTypes.string,
    includeAllOrderBy: PropTypes.string
  }).isRequired
};
